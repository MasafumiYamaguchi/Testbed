...
Scene new_cumulonimbus_scene(Scene scene) {
    scene.top_lobes.reset();scene.developed.reset();scene.centerline.reset();scene.cumulonimbus=CumulonimbusGroup{};scene.cloud=derive_cumulonimbus_recipe(*scene.cumulonimbus);
