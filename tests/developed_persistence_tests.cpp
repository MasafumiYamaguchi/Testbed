...
int main(){try {
    ...
    check(packet.cloud.fields.settings.x==2&&std::memcmp(&packet.cloud.fields,&expected_packet,sizeof(expected_packet))==0,"GPU packet did not contain both developments");
