...
int main(int argc,char** argv){
    ...
    if(argc==2){auto legacy=read_scene(argv[1]);check(legacy.schema_version==5&&legacy.algorithm_version==2&&legacy.cloud.noise==NoiseSettings{}&&legacy.cloud.cuts.size()==1,"v1 scene migrates with all noise disabled");}
