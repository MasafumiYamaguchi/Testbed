...
int main(){try {
    ...
    check(scene.schema_version==8&&scene.algorithm_version==3&&scene.cloud.altitude_density.enabled,"New centerline lacks schema7 algorithm3 full density profile");
