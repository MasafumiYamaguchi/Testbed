...
struct HdrMetadata {Scene scene;std::uint64_t frame=0,revision=0;unsigned view_steps=0,shadow_steps=0;bool cached=false;unsigned sun_cache_resolution=0;bool empty_skip=false;};
