...
function(white_compile_shader filename profile)
  ...
  add_custom_command(OUTPUT "${output}"
    ...
    DEPENDS "${CMAKE_SOURCE_DIR}/shaders/${filename}" "${CMAKE_SOURCE_DIR}/shaders/density.hlsli" "${CMAKE_SOURCE_DIR}/shaders/altitude_density.hlsli" "${CMAKE_SOURCE_DIR}/shaders/developed_density.hlsli" "${CMAKE_SOURCE_DIR}/shaders/top_lobes.hlsli" "${CMAKE_SOURCE_DIR}/shaders/optics.hlsli" "${CMAKE_SOURCE_DIR}/shaders/noise.hlsli" "${CMAKE_SOURCE_DIR}/shaders/cache.hlsli" "${CMAKE_SOURCE_DIR}/shaders/phase.hlsli" "${CMAKE_SOURCE_DIR}/shaders/preview_approx.hlsli" VERBATIM)
